  ...
  return (
    <section className="bg-gray-100 py-5 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="container mx-auto">
          ...
          <div className="relative container mx-auto px-6 py-16 h-full flex flex-col lg:flex-row items-center justify-center">
            ...
            >
              <h1 className="text-4xl md:text-6xl font-extrabold mb-6 tracking-tight leading-tight">
                Safe and Secure Commercial Key Holding Services Manchester
              </h1>
              <p className="text-xl text-gray-100 max-w-lg mb-8 leading-relaxed">
                MAK Security offers excellent commercial key holding services for properties across Greater Manchester and the North West.
              </p>
              <motion.div
                whileInView={{ opacity: 1, y: 0 }}
        ...
        {/* Commercial Key Holding Description */}
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col lg:flex-row gap-12 items-center max-w-7xl mx-auto">
              ...
              >
                ...
                >
                  <span className="text-red-500 font-semibold">What is Commercial Key Holding Manchester?</span> Simply put, we securely hold the keys for businesses in Manchester so we can respond quickly whenever you may need us.
                </motion.p>
                <motion.p
                  className="text-lg text-gray-700 leading-relaxed"
                  initial={{ opacity: 0 }}
                ...
                >
                  MAK Security provides reliable commercial key holding services in Manchester. Our fully trained and vetted officers arrive promptly, ensuring the safety of your business premises. We secure your keys at a local key vault or mobile unit, ensuring they are given only to authorized people.
                </motion.p>
                <motion.div
                  initial={{ opacity: 0 }}
                  whileInView={{ opacity: 1 }}
        ...
        >
          <div className="container mx-auto px-4">
            ...
            >
              With many years of experience in the security industry offering commercial key holding in Manchester and throughout the North West, we have the knowledge and expertise to provide a first-class commercial key holding service and deal with all types of alarm systems and emergency incidents.
            </motion.p>
            <motion.p
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
            ...
            >
              We are able to look after many types of businesses, such as retail properties, medical centres, schools, pubs, clubs, and construction sites, to name just a few.
            </motion.p>
            <motion.div
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
        ...
        >
          <div className="container mx-auto px-4">
            ...
            <motion.p
              ...
              className="text-lg text-gray-600 max-w-3xl mx-auto mb-8"
            >
              If you are looking for reliable commercial key holding in Manchester with a highly trained alarm response team to protect your property, look no further and contact MAK Security.
            </motion.p>
            <motion.p
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
