...
// Main Component: Mobile Security Knowsley Page
export default function MobileSecurityKnowsley() {
  ...
  const howItWorks = [
    {
      title: 'Site Visit',
      description: 'Request a free no obligation quotation. We will be happy to complete a full site survey, risk assessment and discuss all your security requirements in Knowsley.',
    },
    {
      ...
      <section className="bg-[#F7F7F7] py-24 px-4 sm:px-6 lg:px-8 font-sans">
        <div className="container mx-auto">
          ...
          <motion.div
            ...
            style={{
              y,
              backgroundImage: "url('/services/489621777_1718440492296601_8812595996159204720_n.jpg')",
            }}
            ...
            <div className="flex flex-col lg:flex-row items-center gap-8 max-w-6xl mx-auto">
              <div className="w-full lg:w-1/2">
                <h2 className="text-4xl font-semibold text-[#374B5B] mb-8 relative">
                  Mak Security - Mobile Security Patrols Knowsley
                  <span className="absolute bottom-0 left-0 w-32 h-1 bg-[#FF0600] rounded"></span>
                </h2>
                <p className="text-gray-600 text-lg leading-relaxed">
                  Are you looking for a reliable mobile security patrol service in the Knowsley area? Mak Security is an established security company based in Knowsley, we have been providing mobile security patrol services to businesses in Knowsley and across the UK for over 30 years. From large open areas such as educational facilities or more vulnerable locations such as warehouses and shipyards, our fully regulated, SIA-licensed mobile security patrol guards will deliver extensive coverage to maintain a total security solution throughout. MAK is one of the most well-established security companies in Knowsley. As SIA approved security experts we offer a wide range of services which cover the Knowsley and Merseyside area including manned guarding, key holding, CCTV, event security, facility management, car park management, secure concrete block and an extensive court enforcement service. If you are looking for a dedicated, faithful and motivated security company in Knowsley that will provide a fast response to security breaches and protect all areas of your business, call to Mak Security today.
                </p>
              </div>
              <div className="w-full lg:w-1/2">
                <motion.img
                  ...
                  alt="MAK Security Patrol in Knowsley"
          ...
          >
            <h2 className="text-4xl font-semibold text-[#374B5B] mb-8 text-center relative">
              Mobile Security Patrol in Knowsley Benefits
              <span className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-32 h-1 bg-[#FF0600] rounded"></span>
            </h2>
          ...
          {/* Hire a Mobile Security Patrol in Knowsley Section */}
          <motion.div
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            transition={{ duration: 0.8 }}
          ...
          >
            <h2 className="text-4xl font-semibold text-[#374B5B] mb-8 text-center relative">
              Hire a Mobile Security Patrol in Knowsley
              <span className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-32 h-1 bg-[#FF0600] rounded"></span>
            </h2>
            <div className="flex flex-col lg:flex-row items-center gap-8 max-w-5xl mx-auto">
              ...
              >
                <img
                  ...
                  alt="Mobile security patrol in Knowsley"
                  className="w-full h-64 object-cover rounded-lg shadow-md hover:scale-105 transition-transform duration-300"
                />
              </motion.div>
              <div className="w-full lg:w-1/2">
                <p className="text-gray-600 text-lg leading-relaxed">
                  Mak Security have the ability to operate simultaneously over multiple locations and provide services such as internal security and external mobile security patrols in Knowsley, our mobile security patrols can deploy a security solution that operates over more than one specific location at any given time. At Mak Security, we know that being visible is vital to operational success, so you can rely on us to provide fully uniformed mobile security personnel and fully marked security patrol vehicles.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-600 max-w-3xl mx-auto text-lg leading-relaxed">
              MAK offers a high level of professional mobile security patrols in the Knowsley area, boasting an experienced management and support infrastructure team with more than 50 years of experience in the Security Industry and over 30 years experience in the Greater Manchester Police.
            </p>
          </motion.div>
