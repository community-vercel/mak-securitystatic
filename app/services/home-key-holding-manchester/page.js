...
// Main Component
export default function HomeKeyHoldingManchester() {
      ...
      <div className="container mx-auto">
          ...
          <div className="relative container mx-auto px-6 py-16 h-full flex flex-col lg:flex-row items-center justify-center">
            ...
            >
              <h1 className="text-4xl md:text-6xl font-extrabold mb-6 tracking-tight leading-tight">
                Safe and Secure Home Key Holding Manchester
              </h1>
              <p className="text-xl text-gray-100 max-w-lg mb-8 leading-relaxed">
                MAK Security offer excellent home key holding services for properties across Greater Manchester and the North West.
              </p>
              <motion.div
                whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col lg:flex-row gap-12 items-center max-w-7xl mx-auto">
              ...
              >
                ...
                >
                  <span className="text-red-500 font-semibold">What is Home Key Holding Manchester?</span> Simply put, we securely hold the keys for homeowners in Manchester so we can respond quickly whenever you may need us.
                </motion.p>
                <motion.p
                  className="text-lg text-gray-700 leading-relaxed"
                  initial={{ opacity: 0 }}
                ...
                >
                  MAK Security provides reliable home key holding Manchester. Our fully trained and vetted officers arrive promptly ensuring the safety of your property. We secure your keys at a local key vault or mobile unit and ensure that the keys are given only to the authorised people.
                </motion.p>
                <motion.div
                  initial={{ opacity: 0 }}
                  whileInView={{ opacity: 1 }}
                  ...
                  className="pt-4"
                >
                  <a href="/services" className="px-8 py-3 bg-[#FF0600] text-white rounded-lg font-semibold transition-colors shadow-md hover:shadow-lg">
                    Find Out More
                  </a>
                </motion.div>
              </motion.div>
        ...
        >
          ...
          <div className="container mx-auto px-4 relative">
            <div className="text-center mb-16">
              ...
              >
                Our commitment to excellence ensures your home is protected with industry-leading services.
              </motion.p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-blue-100">
                  We comply with all relevant existing regulations when it comes to delivering highly professional home key holding services Manchester.
                </p>
              </motion.div>
              <motion.div
                whileHover={{ y: -5 }}
              ...
              >
                ...
                <p className="text-blue-100">
                  We have been providing key holding services to thousands of satisfied customers.
                </p>
              </motion.div>
            </div>
          </div>
        ...
        >
          <div className="absolute inset-0 z-0">
            <img
              ...
              alt="Home key holding service process"
        ...
        >
          <div className="container mx-auto px-4">
            ...
            >
              Many Years of Home Key Holding Manchester
            </motion.h2>
            <motion.p
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
            ...
            >
              With many years of experience in the security industry offering domestic key holding Manchester and throughout the North-East.
            </motion.p>
            <motion.p
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
            ...
            >
              We have the knowledge and expertise to provide a first-class home key holding security and deal with all types of alarm systems and emergency incidents. We are able to look after all types of properties large to small.
            </motion.p>
            <motion.div
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
        ...
        >
          <div className="container mx-auto px-4">
            ...
            <motion.p
              ...
              className="text-lg text-gray-600 max-w-3xl mx-auto mb-8"
            >
              If you are looking for reliable home key holding Manchester with a highly trained alarm response team to protect your property? Look no further and contact MAK Security.
            </motion.p>
            <motion.p
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
            ...
            <motion.p
              ...
              className="text-lg text-gray-600 max-w-3xl mx-auto"
            >
              We assist your nominated key holder to assess why the alarm has been triggered or we will ensure your property’s safety if we are the key holders. We pride ourselves on our quick alarm response service and can guarantee to be at your building within a short time.
            </motion.p>
            <motion.div
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
        ...
        >
          ...
          <div className="container mx-auto px-4 relative">
            ...
            >
              Some locations will require constant 24-hour security, whilst others may require random security patrols day or night. At MAK Security, we provide an excellent security guard patrolling service to your property, at random or pre-arranged times, to act as a visible deterrent to any potential intruders.
            </motion.p>
            <motion.p
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
            ...
            >
              Mobile patrols are site-specific; you can take advantage to guard a standalone property or we can also provide a local security presence to cover a number of properties in a particular street. We work closely with the local police ensuring all incidents are dealt with promptly and efficiently.
            </motion.p>
            <motion.div
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
            ...
            >
              <div>
                ...
                <p className="text-lg text-gray-600 mb-4">
                  We provide professional, skilled and experienced key holding staff who are all fully trained to attend to your alarms, emergencies or other requirements. Our security staff are SIA licensed, have completed job-specific training and have been trained by our SIA level 3 trainer and by our training manager who has over 30 years of front line experience working for the Greater Manchester Police.
                </p>
              </div>
              <div>
                <h3 className="text-2xl font-semibold text-blue-900 mb-4">What we do</h3>
                <p className="text-lg text-gray-600">
                  Our officers are readily available to respond to your alarms, emergencies or other requirements. Your site would have been previously set up on our secure system which includes all the information we require. On-site we would complete an external and internal manned patrol. We look for any signs of intrusion and site vulnerability. Unlocks and locks can be arranged at specific times and depending on your requirements. MAK invests in cutting edge technology and all the officers are equipped with reporting hardware that sends all reports, including pictures, in real-time.
                </p>
              </div>
            </motion.div>
            <motion.div
        ...
        >
          ...
          <div className="container mx-auto px-4 relative">
            ...
            <motion.p
              ...
              className="text-lg text-blue-100 max-w-3xl mx-auto mb-8"
            >
              As an extension to our core business, MAK Security provides a same day courier service to our clients, operating 24 hours a day, 7 days a week, 365 days a year. This same day service is immediate and flexible – meaning that we can collect and/or deliver at times that suit you or your clients, 24 hours a day.
            </motion.p>
            <motion.p
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
