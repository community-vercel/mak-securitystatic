...
// Main Component
export default function KeyHoldingSecurity() {
      ...
      <div className="container mx-auto">
          ...
          <div className="relative container mx-auto px-6 py-16 h-full flex flex-col lg:flex-row items-center justify-center">
            ...
            >
              <h1 className="text-4xl md:text-6xl font-extrabold mb-6 tracking-tight leading-tight">
                Safe and Secure Key Holding Security Manchester
              </h1>
              <p className="text-xl text-gray-100 max-w-lg mb-8 leading-relaxed">
                MAK Security offers excellent key holding security services for domestic and commercial clients across Greater Manchester and the North West.
              </p>
              <motion.div
                whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-red-700 mb-4">
                Key Holding Security Manchester
              </h2>
            ...
            <div className="flex flex-col lg:flex-row gap-12 items-center max-w-7xl mx-auto">
              ...
              >
                ...
                >
                  <span className="text-red-500 font-semibold">What is Key Holding Security Manchester?</span> Simply put, we securely hold the keys for homes and businesses in Manchester so we can respond quickly whenever you may need us.
                </motion.p>
                <motion.p
                  className="text-lg text-gray-700 leading-relaxed"
                  initial={{ opacity: 0 }}
                ...
                >
                  MAK Security provides reliable key holding services for domestic and commercial clients. Our fully trained and vetted officers arrive promptly, ensuring the safety of your property. We secure your keys at a local key vault or mobile unit, ensuring they are given only to authorized people.
                </motion.p>
                <motion.div
                  initial={{ opacity: 0 }}
                  whileInView={{ opacity: 1 }}
          ...
          <div className="container mx-auto px-4 relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-blue-100">
                  We comply with all relevant regulations to deliver highly professional key holding services in Manchester.
                </p>
              </motion.div>
              <motion.div
                whileHover={{ y: -5 }}
        ...
        >
          <div className="container mx-auto px-4">
            ...
            >
              Many Years of Key Holding Experience
            </motion.h2>
            <motion.p
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
            ...
            >
              With many years of experience in the security industry offering key holding services in Manchester, Liverpool, Birmingham, and throughout the North West, we have the knowledge and expertise to provide a first-class key holding service and deal with all types of alarm systems and emergency incidents.
            </motion.p>
            <motion.p
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
