...
// Main Component
export default function KeyHoldingLiverpool() {
      ...
      <div className="container mx-auto">
          ...
          <div className="relative container mx-auto px-6 py-16 h-full flex flex-col lg:flex-row items-center justify-center">
            ...
            >
              <h1 className="text-4xl md:text-6xl font-extrabold mb-6 tracking-tight leading-tight">
                Safe and Secure Key Holding Services Liverpool
              </h1>
              <p className="text-xl text-gray-100 max-w-lg mb-8 leading-relaxed">
                MAK Security offers excellent key holding services for properties in Liverpool and throughout Merseyside.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  <a href="tel:01512034312" className="flex items-center">
                    <svg
                ...
                <motion.div
                  whileInView={{ opacity: 1, y: 0 }}
                  className="inline-block bg-white text-blue-900 py-3 px-6 rounded-lg font-medium shadow-md hover:shadow-lg transition-all duration-300"
                >
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col lg:flex-row gap-12 items-center max-w-7xl mx-auto">
              ...
              >
                ...
                >
                  <span className="text-red-500 font-semibold">What are Key Holding Services Liverpool?</span> Simply put, we securely hold the keys for homes and businesses in Liverpool so we can respond quickly whenever you may need us.
                </motion.p>
                <motion.p
                  className="text-lg text-gray-700 leading-relaxed"
                  initial={{ opacity: 0 }}
                ...
                >
                  MAK Security provides reliable key holding services for domestic and commercial clients in Liverpool. Our fully trained and vetted officers arrive promptly, ensuring the safety of your property. We secure your keys at a local key vault or mobile unit, ensuring they are given only to authorized people.
                </motion.p>
                <motion.div
                  initial={{ opacity: 0 }}
                  whileInView={{ opacity: 1 }}
        ...
        >
          ...
          <div className="container mx-auto px-4 relative">
            <div className="text-center mb-16">
              ...
              >
                Our commitment to excellence ensures your property is protected with industry-leading services.
              </motion.p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-blue-100">
                  We comply with all relevant regulations to deliver highly professional key holding services in Liverpool.
                </p>
              </motion.div>
              <motion.div
                whileHover={{ y: -5 }}
              ...
              >
                ...
                <p className="text-blue-100">
                  We have provided key holding services to thousands of satisfied customers, from homeowners to large businesses.
                </p>
              </motion.div>
            </div>
          </div>
        ...
        >
          <div className="container mx-auto px-4">
            ...
            >
              Many Years of Key Holding Experience in Liverpool
            </motion.h2>
            <motion.p
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
            ...
            >
              With many years of experience in the security industry offering key holding services in Liverpool, Manchester, Birmingham, and throughout the North West, we have the knowledge and expertise to provide a first-class key holding service and deal with all types of alarm systems and emergency incidents.
            </motion.p>
            <motion.p
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
            ...
            >
              We are able to look after many types of property, including businesses, domestic properties, retail properties, medical centres, schools, pubs, clubs, and construction sites, to name just a few.
            </motion.p>
            <motion.div
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
            ...
            >
              <button className="px-8 py-3 bg-[#FF0600] text-white rounded-lg font-semibold hover:shadow-lg transition-all duration-300">
                Get In Touch
              </button>
            </motion.div>
          </div>
        ...
        >
          <div className="container mx-auto px-4">
            ...
            <motion.p
              ...
              className="text-lg text-gray-600 max-w-3xl mx-auto mb-8"
            >
              If you are looking for reliable key holding services with a highly trained alarm response team to protect your property, look no further and contact MAK Security.
            </motion.p>
            <motion.p
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
