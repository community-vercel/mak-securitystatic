...
// Main Component: Mobile Security Stockport Page
export default function MobileSecurityStockport() {
  ...
  const howItWorks = [
    {
      title: 'Site Visit',
      description: 'Request a free no obligation quotation. We will be happy to complete a full site survey, risk assessment and discuss all your security requirements in Stockport.',
    },
    {
      ...
      <section className="bg-[#F7F7F7] py-24 px-4 sm:px-6 lg:px-8 font-sans">
        <div className="container mx-auto">
          ...
          <motion.div
            ...
            style={{
              y,
              backgroundImage: "url('/services/mobile-security-stockport-1024x433.jpg')",
            }}
            className="relative min-h-[70vh] w-full bg-cover bg-center rounded-3xl shadow-2xl mb-32 "
          >
          ...
          >
            <div className="flex flex-col lg:flex-row items-center gap-8 max-w-6xl mx-auto">
              <div className="w-full lg:w-1/2">
                <h2 className="text-4xl font-semibold text-[#374B5B] mb-9 relative">
                  Mak Security - Mobile Security Patrols Stockport
                  <span className="absolute bottom-0 left-0 w-32 h-1 bg-[#FF0600] rounded"></span>
                </h2>
                <p className="text-gray-600 text-lg leading-relaxed">
                  Are you looking for a reliable mobile security patrol service in the Stockport area? Mak Security is an established security company based in Stockport, we have been providing mobile security patrol services to businesses in Stockport and across the UK for over 30 years. From large open areas such as educational facilities or more vulnerable locations such as warehouses and shipyards, our fully regulated, SIA-licensed mobile security patrol guards will deliver extensive coverage to maintain a total security solution throughout. MAK is one of the most well-established security companies in Stockport. As SIA approved security experts we offer a wide range of services which cover the Stockport area including manned guarding, key holding, CCTV, event security, facility management, car park management, secure concrete block and an extensive court enforcement service. If you are looking for a dedicated, faithful and motivated security company in Stockport that will provide a fast response to security breaches and protect all areas of your business, call to Mak Security today.
                </p>
              </div>
              <div className="w-full lg:w-1/2">
                <motion.img
                  ...
                  transition={{ duration: 0.8 }}
                  viewport={{ once: true }}
                  src="/services/mobile-security-stockport-1024x433 (1).jpg"
                  alt="MAK Security Patrol in Stockport"
          ...
          >
            <h2 className="text-4xl font-semibold text-[#374B5B] mb-8 text-center relative">
              Mobile Security Patrol in Stockport Benefits
              <span className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-32 h-1 bg-[#FF0600] rounded"></span>
            </h2>
          ...
          {/* Hire a Mobile Security Patrol in Stockport Section */}
          <motion.div
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            transition={{ duration: 0.8 }}
          ...
          >
            <h2 className="text-4xl font-semibold text-[#374B5B] mb-8 text-center relative">
              Hire a Mobile Security Patrol in Stockport
              <span className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-32 h-1 bg-[#FF0600] rounded"></span>
            </h2>
            <div className="flex flex-col lg:flex-row items-center gap-8 max-w-5xl mx-auto">
              ...
              >
                <img
                  src="/services/Mobile-security-patrol-stockport.jpg"
                  alt="Mobile security patrol in Stockport"
                  className="w-full h-64 object-cover rounded-lg shadow-md hover:scale-105 transition-transform duration-300"
                />
              </motion.div>
              <div className="w-full lg:w-1/2">
                <p className="text-gray-600 text-lg leading-relaxed">
                  Mak Security have the ability to operate simultaneously over multiple locations and provide services such as internal security and external mobile security patrols in Stockport, our mobile security patrols can deploy a security solution that operates over more than one specific location at any given time. At Mak Security, we know that being visible is vital to operational success, so you can rely on us to provide fully uniformed mobile security personnel and fully marked security patrol vehicles.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-600 max-w-3xl mx-auto text-lg leading-relaxed">
              MAK offers a high level of professional mobile security patrols in the Stockport area, boasting an experienced management and support infrastructure team with more than 50 years of experience in the Security Industry and over 30 years experience in the Greater Manchester Police.
            </p>
          </motion.div>
                ...
                >
                  ...
                  >
                    <path
                      ...
                      strokeWidth="2"
                      d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21 sondel-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"
                    />
                  </svg>
                  Get a Quote
                </button>
