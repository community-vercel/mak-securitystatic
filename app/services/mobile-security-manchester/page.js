    ...
    <>
      ...
      <section className="bg-[#F7F7F7] py-24 px-4 sm:px-6 lg:px-8 font-sans">
        <div className="container mx-auto">
          ...
          {/* Why Choose MAK Security Section - Fixed below header with image */}
          <motion.div
            initial={{ opacity: 0 }}
          ...
          {/* How It Works Section - 3 items horizontally on md+, vertical on sm */}
          <motion.div
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            transition={{ duration: 0.8 }}
          ...
          {/* Mobile Security Patrol Benefits Section - 3 items horizontally */}
          <motion.div
            ref={benefitsRef}
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
          ...
          {/* Mobile Security Patrol in Oldham Section */}
          <motion.div
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            transition={{ duration: 0.8 }}
