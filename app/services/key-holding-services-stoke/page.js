...
// Main Component
export default function KeyHoldingServicesManchester() {
      ...
      <div className="container mx-auto">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col lg:flex-row gap-12 items-center max-w-7xl mx-auto">
              ...
              >
                ...
                >
                  <span className="text-red-500 font-semibold">What are Key Holding Services Manchester?</span> Simply put, we securely hold the keys for homes and businesses in Manchester so we can respond quickly whenever you may need us.
                </motion.p>
                <motion.p
                  className="text-lg text-gray-700 leading-relaxed"
                  initial={{ opacity: 0 }}
                ...
                >
                  MAK Security provides reliable key holding services for domestic and commercial clients in Manchester. Our fully trained and vetted officers arrive promptly, ensuring the safety of your property. We secure your keys at a local key vault or mobile unit, ensuring they are given only to authorized people.
                </motion.p>
                <motion.div
                  initial={{ opacity: 0 }}
                  whileInView={{ opacity: 1 }}
        ...
        >
          <div className="container mx-auto px-4">
            ...
            >
              Many Years of Key Holding Experience in Manchester
            </motion.h2>
            <motion.p
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
