...
export default function SecurityServicesCheshire() {
  ...
  const subAreas = [
    { name: 'Chester', postcode: 'CH1 1LN', areas: 'Blacon, Boughton, Handbridge, Hoole, Upton' },
    { name: 'Warrington', postcode: 'WA1 1QB', areas: 'Latchford, Stockton Heath, Penketh, Great Sankey, Orford' },
    { name: 'Crewe', postcode: 'CW1 2DA', areas: 'Nantwich, Sandbach, Haslington, Wistaston, Shavington' },
    { name: 'Macclesfield', postcode: 'SK10 1EA', areas: 'Bollington, Prestbury, Tytherington, Poynton, Adlington' },
    { name: 'Widnes', postcode: 'WA8 0TA', areas: 'Runcorn, Hale, Cronton, Ditton, Hough Green' },
  ];

  const processSteps = [
    {
      title: '1. Site Visit',
      description: 'Request a free, no-obligation quotation. We complete a full site survey, risk assessment, and discuss your security requirements tailored to Cheshire.',
    },
    {
    ...
    },
    {
      ...
      description: 'A dedicated account manager is assigned to you, available 24/7 to ensure ongoing satisfaction and support across Cheshire.',
    },
  ];
  ...
  return (
    <section className="bg-gray-50 py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="container mx-auto max-w-9xl">
        ...
        >
          <Image
            src="/services/Mak-Security-Van.jpg"
            alt="Security Services in Cheshire"
            fill
...
System: -cover"
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-red-900/85 to-red-300/60 flex items-center justify-center">
            <div className="text-center text-white px-4">
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-4 drop-shadow-lg leading-tight">
                Cheshire Security Services
              </h1>
              <p className="text-lg md:text-xl max-w-3xl mx-auto drop-shadow-md leading-relaxed">
                Expert commercial and domestic security solutions across Cheshire, with SIA-approved services from our Audenshaw, Manchester office.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        <section className="py-12 sm:py-16">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 leading-tight">
              Expert Security Solutions in Cheshire
            </h2>
            <div className="w-24 h-1 bg-red-600 mx-auto"></div>
            <p className="text-base md:text-lg text-gray-600 mt-4 max-w-3xl mx-auto leading-relaxed">
              MAK Security, based in Audenshaw, Manchester, delivers comprehensive security services across Cheshire, including manned guarding, CCTV, key holding, event security, and concrete block hire.
            </p>
          </motion.div>
        ...
        >
          ...
          <div className="container mx-auto px-4 relative">
            <div className="text-center mb-16">
              ...
              >
                MAK Security is one of the most established security companies in Cheshire, offering SIA-approved services with over 50 years of security industry experience and 30 years with Greater Manchester Police.
              </motion.p>
            </div>
              ...
              >
                <div className="relative group rounded-2xl overflow-hidden shadow-2xl">
                  <Image
                    ...
                    alt="MAK Security team in Cheshire"
                    width={400}
                    height={400}
        ...
        <section className="py-12 sm:py-16">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 leading-tight">
              Areas We Cover Around Cheshire
            </h2>
            <div className="w-24 h-1 bg-red-600 mx-auto"></div>
            <p className="text-base md:text-lg text-gray-600 mt-4 max-w-3xl mx-auto leading-relaxed">
              We provide comprehensive security services across Cheshire, including Chester, Warrington, Crewe, Macclesfield, and Widnes, ensuring a safe and secure environment.
            </p>
          </motion.div>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 sm:gap-10">
        ...
        >
          <h3 className="text-2xl md:text-3xl font-semibold mb-2">Secure Cheshire Today</h3>
